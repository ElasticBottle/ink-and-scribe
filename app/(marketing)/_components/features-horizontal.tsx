    ...
    <section ref={ref} id="features">
      <div className="container">
        <div className="mx-auto max-w-6xl ">
          <div className="">
            <div
              className={`order-1 hidden md:order-none md:flex ${
            ...
            >
              {data[currentIndex]?.image ? (
                <motion.img
                  ...
                  alt="feature"
                  className="relative aspect-auto size-full rounded-lg border object-cover shadow-lg"
                ...
                <video
                  ...
                  className="aspect-auto size-full rounded-lg border object-cover shadow-lg"
                  autoPlay
                  loop
                  muted
                />
              ) : (
                <div className="aspect-auto size-full min-h-[600px] rounded-xl border border-neutral-300/50 bg-gray-200 p-1" />
              )}
              <BorderBeam
                size={400}
                duration={12}
